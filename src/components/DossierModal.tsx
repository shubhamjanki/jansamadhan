        ...
        <div className="p-3 sm:p-4 bg-surface-container-low border-t border-surface-container-high flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="flex-1 sm:flex-initial bg-secondary hover:bg-secondary/90 text-on-secondary px-4 sm:px-5 py-2 rounded-lg font-label-md text-label-md transition-colors cursor-pointer font-bold shadow-xs flex items-center justify-center gap-1.5 text-center"
            >
